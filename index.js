...
const capikey = process.env.CLIENT_KEY;
const egg = process.env.EGG_ID;
const nestid = process.env.NEST_ID;
...
app.listen(3000, () => console.log("Joocode Panel API aktif di port 3000"));
